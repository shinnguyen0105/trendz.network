    ...
    <div className='wrapper'>
      <div className='main'>
        <Card className='mt-1'>
          <Container>
            <Link href='/'>
              <Button color='primary'>Home Page Trendz Network</Button>
            </Link>
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to Trendz Network.
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to Trendz Network, accessible
                  from{' '}
                  <a
                    href='http://www.trendz-network.com'
                    rel='external nofollow noopener'
                    target='_blank'
                  >
                    http://www.trendz-network.com
                  </a>
                </p>
              </li>
              <li>
            ...
            <ul>
              <li>By email: trendz.networksys@gmail.com</li>
            </ul>
          </Container>
        </Card>
      </div>
